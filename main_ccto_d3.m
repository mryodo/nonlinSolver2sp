function main_ccto_d3()
    ...
    for i=1:length(d12)
        for j=1:length(sm2)
            ...
            [N1, N2, ~, ~, ~, ~]=solver(N1, N2, D11, D12, D22, w11, w12, w21, w22, d11, d12(i), d21, d22, m1, m2, b1, b2, d1, d2, h, A, al, N, 3);
            N1_ans(i, j)=N1;
            N2_ans(i, j)=N2;
            display(100*(i-1)+j);
        end
    end
    dlmwrite('N1cctoD3_04_d.txt', N1_ans);
    dlmwrite('N2cctoD3_04_d.txt', N2_ans);
    figure;
    hold on;
    grid on;
    surf(d12, sm2, N1_ans);
